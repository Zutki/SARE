...
Also do note that to use a Logger, you must replace any calls to System.out.println() in the code, I am aware that this
...
public class Main {
    public static void main(String[] args) {
        ...
        Thread renderThread = new Thread(renderEngine, "Render Thread");
        renderThread.start();
        RenderEngine.addEventToQueue(() -> RenderEngine.setTitle("SARE Hello World!"));
        RenderEngine.addEventToQueue(() -> RenderEngine.setWindowDimension(1920/2, 1080/2));
    }
}
